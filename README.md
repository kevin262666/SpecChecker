...
### v1.5.1 - 修復 iframe 使用體驗問題
- **修復遮擋問題**: 不再對 iframe 元素本身顯示 tooltip，避免遮擋用戶想查看的內容
- **修復截圖限制**: 移除 iframe 內截圖功能的限制，現在可以在任何框架中正常截圖
- **改善使用體驗**: 針對整頁都是 iframe 的網站優化使用體驗
- **測試更新**: 更新測試檔案說明，反映新的修復內容
